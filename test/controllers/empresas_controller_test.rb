...
class EmpresasControllerTest < ActionController::TestCase
  ...
  test "should create empresa" do
    assert_difference('Empresa.count') do
      post :create, empresa: { direccion: @empresa.direccion, pais: @empresa.pais, razon_social: @empresa.razon_social, responsable: @empresa.responsable }
    end
  ...
  test "should update empresa" do
    patch :update, id: @empresa, empresa: { direccion: @empresa.direccion, pais: @empresa.pais, razon_social: @empresa.razon_social, responsable: @empresa.responsable }
    assert_redirected_to empresa_path(assigns(:empresa))
  end
